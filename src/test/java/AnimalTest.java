...
public class AnimalTest {
    ...
    @Test
    public void getName_animalInstantiatesWithName_Bear() {
        Animal testAnimal = new Animal("Bear");
    ...
    public void equals_returnsTrueIfNameIsTheSame_false() {
        ...
        Animal anotherAnimal = new Animal("Bear");
    ...
    public void all_returnsAllInstancesOfAnimal_false() {
        Animal firstAnimal = new Animal("Bear");
        firstAnimal.save();
        Animal secondAnimal = new Animal("Blue Dog");
        secondAnimal.save();
    ...
    public void updateName_updatesAnimalNameInDatabase_String() {
        Animal testAnimal = new Animal("Bear");
        testAnimal.save();
        testAnimal.updateName("Elephant");
